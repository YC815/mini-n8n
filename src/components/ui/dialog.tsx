...
/**
 * 1. DialogRoot 不需要拿到外部的 ref，保持原写法即可。
 * 2. 下面所有直接基于 Radix Primitive 需要 ref 的地方都改成 forwardRef。
 */
          ...
          <DialogPrimitive.Close
            ...
            className={cn(
              "absolute top-4 right-4 rounded-xs opacity-70 transition-opacity " +
                "focus:ring-ring ring-offset-background data-[state=open]:bg-accent " +
                "data-[state=open]:text-muted-foreground hover:opacity-100 " +
